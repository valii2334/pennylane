...
--
-- Name: index_recipe_tags_on_recipe_id_and_tag_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_recipe_tags_on_recipe_id_and_tag_id ON public.recipe_tags USING btree (recipe_id, tag_id);
